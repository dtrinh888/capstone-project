describe('Genre List Controller', function(){
    ...
    inject(function($httpBackend, $rootScope, $route, $location){
        ...
        // Instead of checking the selected genre, we want to check the route param
        // to see if the page was routed successfully.  Route params will be strings.
        expect($route.current.params.genreId).toBe('80');

        // After changing the route, selected genre gets reset so check that
